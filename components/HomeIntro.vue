<template>
  <div>
  <div id="ie89vi" data-component-theme="" class="sectionBlockLayout text-left bg1"
    style=''>
    <div id="ikc8xt" class="container" style="padding: 0px; display: flex; flex-wrap: wrap;">
      <div id="i1bv6e" class="col-md-4 columnBlockLayout"
        style="flex-grow: 1; display: flex; flex-direction: column; min-width: 250px; word-break: break-word;">
        <h1 id="ii9n4f" style="text-align: left; color: var(--portalThemeColor1);"> <b id="i44w7"
            aria-label="텍스트 이오그램과 함께, AI가 여행과 마케팅을 바꾸는 순간을 만나보세요! 편집하려면 Enter 키를 누르세요" style="position: relative;">이오그램과
            함께, <br>당신의 비즈니스가 AI로 더 편리해지는 경험을 해보세요!</b></h1>
        <p id="ih1ach" style="color: var(--portalThemeColor1);">EOGRAM은 데이터와 디지털 기술을 활용하여 기업의 비즈니스 성장을 위한 최적의 솔루션을
          제공합니다.</p>
        <button onclick="window.location.href='/solutions'" type="button" value="솔루션" id="ijrb2w" class="button1">솔루션
          안내</button>
      </div>
      <div id="ib19dz" class="col-md-8 columnBlockLayout"
        style="flex-grow: 1; display: flex; flex-direction: column; min-width: 250px; word-break: break-word;"><video
          allowfullscreen="allowfullscreen"
          src="@/assets/video/aigerDemo.mp4"
          controls="controls" id="i1u8ck" data-componentname="Video"
...
<div data-component-theme="portalThemeColor7" id="it3wq" class="sectionBlockLayout text-left" style="display: flex; flex-wrap: wrap; margin: 0px; min-height: auto; padding: 8px; background-position: center center; background-repeat: no-repeat; background-size: cover;">
  ...
  <!-- <div data-component-theme="portalThemeColor7" id="it3wq" class="sectionBlockLayout text-left"
    style="display: flex; flex-wrap: wrap; margin: 0px; min-height: auto; padding: 8px;">
    <div id="it5rg" class="container" style="padding: 0px; display: flex; flex-wrap: wrap;">
      <div id="iyf4u" class="col-md-6 columnBlockLayout"
        style="word-break: break-word; flex-grow: 1; display: flex; flex-direction: column; min-width: 300px;">
        <h1 id="il5e2">Our Mission</h1>
        <p id="immdt">데이터와 디지털 기술을 활용하여 기업의 비즈니스 성장을 위한 최적의 솔루션을 제공합니다.</p>
      </div>
      <div id="ivy7o4" class="col-md-6 columnBlockLayout"
        style="word-break: break-word; flex-grow: 1; display: flex; flex-direction: column; min-width: 300px;"><img
          src="@/assets/img/intro1.jpg" alt="intro1" name="intro1.jpg" id="iz3xji"
...
<div id="i64y2j" data-component-theme="portalThemeColor7" class="sectionBlockLayout text-left" style="display: flex; flex-wrap: wrap; margin: 0px; min-height: auto; padding: 8px;">
  ...
  <div id="imq7in" data-component-theme="portalThemeColor7" class="sectionBlockLayout text-left"
    ...
    <div id="igdevf" class="container" style="padding: 0px; display: flex; flex-wrap: wrap;">
      <div id="ixlc18" class="col-md-4 columnBlockLayout"
        style="flex-grow: 1; display: flex; flex-direction: column; min-width: 250px; word-break: break-word;">
...
<div data-component-theme="portalThemeColor5" id="inc22d" class="sectionBlockLayout text-left" style="display: flex; flex-wrap: wrap; margin: 0px; min-height: auto; padding: 0px;">
  ...
  <!-- <div data-component-theme="portalThemeColor7" id="iclp3h" class="sectionBlockLayout text-left"
    ...
    <div id="i83a1o" class="container" style="padding: 0px; display: flex; flex-wrap: wrap;">
      <div id="i9s0cf" class="col-md-12 columnBlockLayout"
        style="word-break: break-word; flex-grow: 1; display: flex; flex-direction: column; min-width: 300px;">
        <div id="History" data-v-27a4685c="" class="History tab">
          <h1 id="ity1ba" style="text-align: left;">History</h1>
          <div id="ign9ft" class="sectionBlockLayout"
            style="display: flex; flex-wrap: wrap; padding: 8px; margin: 0px; min-height: 15px;"></div>
          <div data-v-27a4685c="" id="i5q6en" class="historyCont body" style="height: fit-content;">
            <ul data-v-27a4685c="">
              <li data-v-27a4685c="">
                <h4 data-v-27a4685c="" id="ijg5th">현재</h4>
                <p data-v-27a4685c="" id="ijel5r">생성형 AI 기반 기업(B2B) 데이터연계 분석/Reporting 플랫폼 개발(R&amp;D) (AIGER)<br />기업은행
                  1st LAB 에서의 혁신과제 수행 (LLM 기반의 데이터 분석 플랫폼)</p>
              </li>
              <li data-v-27a4685c="">
                <h4 data-v-27a4685c="">2023. 08</h4>
                <p data-v-27a4685c="">디지털 마케팅을 위한 비대면 오퍼 시스템 구축</p>
              </li>
              <li data-v-27a4685c="">
                <h4 data-v-27a4685c="">2023. 02</h4>
                <p data-v-27a4685c="">AI기반 마케팅 자동화 시스템 구축</p>
              </li>
              <li data-v-27a4685c="">
                <h4 data-v-27a4685c="">2022. 07</h4>
                <p data-v-27a4685c="">AI 기반 실시간마케팅 시스템 구축</p>
              </li>
              <li data-v-27a4685c="">
                <h4 data-v-27a4685c="">2021. 10</h4>
                <p data-v-27a4685c="">취향 기반 여행정보 커뮤니티 플랫폼 개발(EOSAM)</p>
              </li>
              <li data-v-27a4685c="">
                <h4 data-v-27a4685c="">2021. 04</h4>
                <p data-v-27a4685c="">주식회사 이오그램 설립</p>
              </li>
            </ul>
          </div>
        </div>
